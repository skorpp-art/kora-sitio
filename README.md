...
| `.mcp.json` | Servidores MCP de Hostinger (VPS, DNS, dominios). Necesita la variable `HOSTINGER_API_TOKEN` en el entorno — ver [`docs/hostinger-mcp.md`](docs/hostinger-mcp.md) |
