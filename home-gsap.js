/* ==========================================================================
   KORA — Home "Pizarra GSAP"
   Comportamiento exclusivo de index.html: rotador del titular, reveals y
   línea de proceso con GSAP, contadores, acordeón FAQ, formulario,
   tooltips, nav y transiciones de página.
...
(function () {
  ...
  /* C. Formas del hero flotando (yoyo infinito) */
  function initFloaters() {
    if (!GSAP_OK) return;
    var shapes = document.querySelectorAll('.hero__shape, [data-float]');
  ...
  /* D. Reveals al scroll: cualquier [data-reveal] entra con autoAlpha + y */
